...
- Root Directory: `output/scroll-world-concept-v1`
- Build Command: 비워 둠
- Output Directory: 비워 둠

순수 HTML, CSS, JavaScript 구성이라 빌드 과정이 없습니다. 배포 후 `/`에서 `index.html`이 열립니다.

Vercel Hobby의 업로드 제한을 맞추기 위해 `.vercelignore`가 제작 중간 산출물과 보존용 원본 PNG를 제외합니다. 화면에는 품질 92의 WebP 사본을 사용하며, 원본 PNG는 로컬 통합 폴더 안에 그대로 남아 있습니다.
